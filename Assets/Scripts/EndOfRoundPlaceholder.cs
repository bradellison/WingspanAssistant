...
public class EndOfRoundPlaceholder : MonoBehaviour
{
    ...
    private void OnMouseDown() {
        ...
        print(endOfRoundGoals.endOfRoundLocations.IndexOf(this.transform.parent.gameObject) + "  " + endOfRoundGoals.endOfRoundGoals.Count);
        if (endOfRoundGoals.endOfRoundLocations.IndexOf(this.transform.parent.gameObject) > endOfRoundGoals.endOfRoundGoals.Count)
        {
            return;
        }
        ...
        for (int i = 0; i < 100; i++)
        {
            ...
            if (!endOfRoundGoals.chosenGoals.Contains(newSprite))
            {
                ...
                endOfRoundGoals.endOfRoundGoals.Add(goal.GetComponent<EndOfRoundGoal>());
                return;
            }
        }
